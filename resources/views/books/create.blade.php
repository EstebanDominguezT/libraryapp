    ...
    <form action="{{ route('books.store') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control" name="description" id="description" cols="15" rows="10"></textarea>
            ...
            <div class="col-md-2">
                ...
                <input type="number" class="form-control" id="total_copies" name="total_copies" value="{{ old('total_copies') }}">
            ...
            <div class="col-md-2">
                ...
                <input type="number" class="form-control" id="available_copies" name="available_copies" value="{{ old('available_copies') }}">
